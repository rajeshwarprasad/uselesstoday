...
export const currentUser = {
  id: "u-Rajeshwar",
  name: "Rajeshwar",
  email: "Rajeshwar@uselesstoday.com",
  avatar_url: null,
  created_at: iso(-60),
};
...
const team = [
  currentUser,
  { id: "u-maya", name: "Maya Chen", email: "maya@uselesstoday.com", avatar_url: null },
  { id: "u-diego", name: "Diego Santos", email: "diego@uselesstoday.com", avatar_url: null },
  { id: "u-priya", name: "Priya Nair", email: "priya@uselesstoday.com", avatar_url: null },
  { id: "u-sam", name: "Sam Okafor", email: "sam@uselesstoday.com", avatar_url: null },
  { id: "u-lena", name: "Lena Fischer", email: "lena@uselesstoday.com", avatar_url: null },
];
const byId = Object.fromEntries(team.map((u) => [u.id, u]));

/* ---------------------------------- boards ----------------------------------- */
const boardMetas = [
  { id: "b-roadmap", title: "Product Roadmap", description: "Quarterly planning, OKRs and feature prioritization.", color: "#2f8159", owner: "u-Rajeshwar", members: ["u-maya", "u-diego", "u-priya"], updatedDaysAgo: 0.3,
  ...
  { id: "b-mobile", title: "Mobile App Launch", description: "Ship the iOS & Android apps to the stores.", color: "#c26a45", owner: "u-Rajeshwar", members: ["u-sam", "u-lena"], updatedDaysAgo: 1.2,
  ...
  { id: "b-website", title: "Website Redesign", description: "Marketing site refresh with a new design language.", color: "#5f7da6", owner: "u-Rajeshwar", members: ["u-lena", "u-diego"], updatedDaysAgo: 2.6,
  ...
  { id: "b-marketing", title: "Marketing Q3", description: "Campaigns, content and growth experiments.", color: "#d4a23c", owner: "u-Rajeshwar", members: ["u-diego", "u-priya"], updatedDaysAgo: 4,
    titles: ["Launch email sequence", "Social calendar", "Webinar planning", "Case study writeup", "Ad creative refresh"] },
  { id: "b-design", title: "Design System", description: "Tokens, components and documentation.", color: "#2c9c8f", owner: "u-Rajeshwar", members: ["u-lena", "u-maya"], updatedDaysAgo: 0.8,
    titles: ["Token naming audit", "Button component", "Form primitives", "Theme tokens", "Icon set cleanup", "Documentation site"] },
  // shared with Rajeshwar (owned by teammates)
  { id: "b-eng", title: "Engineering Sprint", description: "Current two-week delivery sprint.", color: "#6f9b54", owner: "u-maya", members: ["u-Rajeshwar", "u-sam", "u-diego"], updatedDaysAgo: 1.8,
  ...
  { id: "b-content", title: "Content Calendar", description: "Editorial pipeline for blog & newsletter.", color: "#4f9d82", owner: "u-diego", members: ["u-Rajeshwar", "u-priya"], updatedDaysAgo: 9,
...
const buildDetail = (meta) => {
  ...
  if (!memberKeys.includes("u-Rajeshwar")) memberKeys.push("u-Rajeshwar");
  ...
  const assignPool = ["u-Rajeshwar", "u-Rajeshwar", ...memberKeys];
  ...
  return { board, columns, tasks, members, role: meta.owner === "u-Rajeshwar" ? "owner" : "member" };
};
...
export const activitiesFor = (boardId) => {
  ...
  const samples = [
    { action: "task.created", message: `${names[0] || "Rajeshwar"} created "${d.tasks?.[0]?.title || "a task"}"` },
    { action: "task.moved", message: `${names[1] || "Maya"} moved "${d.tasks?.[1]?.title || "a task"}" to Done` },
    { action: "member.added", message: `${names[0] || "Rajeshwar"} added ${names[2] || "Diego"} to the board` },
  ...
  return samples.map((a, i) => ({
    ...
    user_name: names[i % names.length] || "Rajeshwar",
    user_avatar: null,
    action: a.action,
    message: a.message,
