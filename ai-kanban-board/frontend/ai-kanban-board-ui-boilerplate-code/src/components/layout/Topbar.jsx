...
import { ChevronDown, LogOut, Plus, Search, Command, Settings } from "lucide-react";
          ...
          {menuOpen && (
            <div className="card animate-in absolute right-0 mt-2 w-56 rounded-2xl p-1.5 shadow-[var(--shadow-lift)]">
              ...
              <button
                ...
                className="flex w-full items-center gap-2 rounded-xl px-3 py-2 text-sm text-priority-urgent transition-colors hover:bg-priority-urgent/10"
              >
