...
import DeleteColumnConfirm from "../ui/DeleteColumnConfirm";
import { cn, columnAccent } from "../../lib/utils";

const Column = ({ column, tasks, index = 0, onTaskClick, onAddTask, onRename, onDelete, onAiGenerate, isOwner = false }) => {
  ...
  return (
    ...
    >
      ...
      {/* Drop zone */}
      <div ref={setNodeRef} className="flex flex-1 flex-col gap-2.5 overflow-y-auto px-0.5 pb-1 no-scrollbar" data-print="tasks">
