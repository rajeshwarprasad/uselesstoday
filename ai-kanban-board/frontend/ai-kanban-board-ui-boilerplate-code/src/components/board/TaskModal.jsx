...
import { Trash2, GitBranch, Loader2, ArrowRightLeft } from "lucide-react";
...
const TaskModal = ({ open, onClose, task, defaultColumnId, columns, members, actions, onBreakdown, currentBoardId, companyId, onTaskMoved }) => {
  ...
  useEffect(() => {
    ...
    if (task) {
      setForm({
        ...
        start_date: toDateInput(task.start_date) || toDateInput(new Date()),
          ...
          <div className="flex items-center gap-1">
            {isEdit && (
              <>
                ...
                <Button type="button" variant="ghost" onClick={() => setMoveOpen(true)}>
